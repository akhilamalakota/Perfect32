    ...
    function setupFormValidation(form) {
        ...
        form.addEventListener('submit', (e) => {
            ...
            <div class="booking-success">
              ...
              <p style="margin-top: 16px; font-size: 13px; color: #718096;">If you need immediate assistance, call us at <a href="tel:+919966396497" style="color:#0E8B8B; font-weight:600;">+919966396497</a></p>
            </div>`;
                }
            }, 1500);
        });
